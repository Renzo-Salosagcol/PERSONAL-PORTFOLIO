      ...
      <div className="container mx-auto max-w-5xl">
        ...
        <div className=" grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h3 className="font-semibold">Passionate Full Stack Web Developer</h3>
            ...
            <div className="gradient-border p-6 card-hover">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">Creating websites</p>
                </div>
              </div>
            </div>
            <div className="gradient-border p-6 card-hover">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-semibold text-lg">UI/UasadsaX design</h4>
                  <p className="text-muted-foreground">Creatsaadsing user-friendly interfaces</p>
                </div>
              </div>
            </div>
            <div className="gradient-border p-6 card-hover">
