    ...
    <section id="projects" className="py-24 px-4 relative">
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="text-center mt-12">
          <a className="cosmic-button w-fit flex items-center gap-2 mx-auto hover:cursor-pointer"
            href="https://github.com/Renzo-Salosagcol" target="_blank" rel="noopener noreferrer">
